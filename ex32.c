...
*  assigned after January 1, 2007 contain 13 digits in five groups, such as
...
main(){
    ...
    printf("Enter ISBN: ");
    scanf("%3d-%1d-%3d-%4d-%1d", &gs1, &group_identifier, &publisher_code, &item_number, &check_digit);
    printf("GS1 prefix: %d\n", gs1);
